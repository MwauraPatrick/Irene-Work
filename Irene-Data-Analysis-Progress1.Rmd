...
Tem1 %>% flextable() %>% theme_zebra() %>% border%>% add_header_lines(values="TEM Genes antibiotics Resistant profile")%>% border(border=fp_border(color = "black"),part = "all") %>% fontsize(i=1,size=14,part="header")
...
CTX1 %>% flextable() %>% theme_zebra %>% border%>% add_header_lines(values="CTX-M Genes antibiotics Resistant profile")%>% border(border=fp_border(color = "black"),part = "all") %>% fontsize(i=1,size=14,part="header")
...
IRENE_DATA_ANALYSIS_R %>% filter(mo=="Escherichia coli") %>% select(LPS,TEM)%>% filter(TEM!="NEG")%>% filter(TEM!="") %>% tabyl(TEM,LPS) %>%adorn_percentages("col")%>%
  adorn_pct_formatting(digits = 0)%>% flextable() %>%  theme_zebra() %>% border%>% add_header_lines(values="TEM GENE")%>% border(border=fp_border(color = "black"),part = "all") %>% fontsize(i=1,size=14,part="header")
...
IRENE_DATA_ANALYSIS_R %>% filter(mo=="Escherichia coli")%>% select(CTX_M,LPS) %>% filter(CTX_M!="NEG") %>% filter(CTX_M!="")%>% tabyl(CTX_M,LPS) %>%adorn_percentages("col")%>%
  adorn_pct_formatting(digits = 0) %>% flextable() %>%  theme_zebra() %>% border%>% add_header_lines(values="CTX-M GENE")%>% border(border=fp_border(color = "black"),part = "all") %>% fontsize(i=1,size=14,part="header")
...
BG1 %>% flextable() %>%  theme_zebra() %>% border%>% add_header_lines(values="Beta-Lactams TEM GENE Resistant profile")%>% border(border=fp_border(color = "black"),part = "all") %>% fontsize(i=1,size=14,part="header")
